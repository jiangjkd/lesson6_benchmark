...
pub fn kundi_staging_testnet_config() -> Result<ChainSpec, String> {
	...
	Ok(ChainSpec::from_genesis(
		...
		"kundi_testnet",
		ChainType::Live,
		move || kundi_staging_testnet_genesis(wasm_binary),
		boot_nodes,
		Some(
			TelemetryEndpoints::new(vec![(STAGING_TELEMETRY_URL.to_string(), 0)])
				.expect("Kundi testnet telemetry url is valid; qed")
		),
		Some("kundi_testnet"),
		None,
		Default::default(),
...
fn kundi_staging_testnet_genesis(wasm_binary: &[u8]) -> GenesisConfig {
